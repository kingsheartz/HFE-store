function check() {
  ...
  location.href = "products.php?product=" + ele;
}
    ...
    for (var i = 0; i < item.length; i++) {
      ...
      if (item[i].category == cat) {
        ...
        if (n > -1) {
          ...
          att1.value =
            "margin: 0;padding: 7px 10px;border: 1px solid #CCCCCC;border-top: none;cursor: pointer;"; // Set the value of the class attribute
