...
<html>
<head>
      <title>NO NETWORK || HFE-Store</title>
  ...
  <div id="wrap">
    <div id="wordsearch">
      <ul>
        ...
        <li class="twelve">u</li>

        <li class="thirteen">n</li>

        <li class="fourteen">d</li>
    ...
    <div id="main-content" style="color: #335B67">
      ...
      <p>Please try again when you are connected to the internet. Go to <a href="../../../../hfe.php" style="color:#007BFF;;font-weight: bold;">Home Page</a>or try to <a style="color:#007BFF;font-weight: bold;" href="../../../../login.php">Log in</a> .</p>
