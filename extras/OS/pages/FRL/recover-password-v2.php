...
$sql = "select attempt,password_reset from customers where password_reset=$otp";
...
<head>
  ...
  <title>HFE | Recover Password (v2)</title>
  <!--favicon-->
...
<body class="hold-transition login-page">
  <div class="recover-password-bg-overlay">
