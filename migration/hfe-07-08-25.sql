...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2025 at 07:04 PM
...
--
-- Table structure for table `bmi_entries`
--
...
--
-- Dumping data for table `bmi_entries`
--

INSERT INTO `bmi_entries` (`bmi_id`, `customer_id`, `weight_kg`, `height_cm`, `bmi`, `date_logged`) VALUES
(2, 68, 70.00, 172.00, 23.66, '2025-08-01'),
(4, 68, 70.00, 172.00, 23.66, '2025-08-03');
...
INSERT INTO `calories` (`calories_id`, `customer_id`, `food_item`, `calories`, `date_logged`) VALUES
(1, 68, '🍎Apple 2', 192, '2025-08-01'),
(2, 68, '🍌Banana 2', 222, '2025-08-01'),
(4, 68, '🥩Beef 170g', 265, '2025-08-01'),
(5, 68, '🍗Chicken 1/2', 764, '2025-08-01');
...
CREATE TABLE `calorie_goals` (
  `customer_id` int(11) NOT NULL,
  `goal` int(11) NOT NULL CHECK (`goal` >= 0),
...
INSERT INTO `calorie_goals` (`customer_id`, `goal`, `updated_at`) VALUES
(68, 2600, '2025-08-01 19:03:38');
...
(36, 67, 651, 5, 1, 5990, 'booking', '2025-04-25', '19:57:08'),
(35, 5, 668, 5, 1, 2750, 'booking', '2025-04-25', '18:31:46'),
(34, 5, 651, 5, 1, 5990, 'booking', '2025-04-25', '18:16:16'),
(32, 67, 668, 5, 2, 5500, 'booking', '2025-04-24', '08:02:03'),
(33, 65, 668, 5, 1, 2750, 'booking', '2025-04-25', '18:07:42'),
(41, 68, 651, 5, 2, 9000, 'booking', '2025-08-05', '18:18:09');
...
(68, 'GOVIND', 'A S', 8113990368, 680312, 'Chengallur', '0', '0', 'ARAKKAPARAMBIL (H), P.O CHENGALOOR, VALANJUPADAM, THRISSUR - 680 312', 1, 'govind.das279@gmail.com', '$2y$10$f6uFlJtYBo7vU2cTkKyHIeR63b8eR6FBcfQZZJFR3Kcse.r/JmZse', 'activated', NULL, 0);
...
(28, 68, 'GOVIND', 'A S', 'ARAKKAPARAMBIL (H), P.O CHENGALOOR, VALANJUPADAM, THRISSUR - 680 312', 8113990368, NULL, 680312, 'permanent');
...
(33, 23, 138, 'booking', 1, 5990, NULL, 'pending'),
(34, 24, 138, 'delivery', 1, 5990, NULL, 'pending'),
(35, 25, 138, 'booking', 1, 5990, NULL, 'pending');
...
(23, 23, '1', '5990', '2025-08-03'),
(24, 24, '1', '5990', '2025-08-03'),
(25, 25, '1', '5990', '2025-08-03');
...
(686, 5, 136, 0, 'yes', '5990', 107, 1),
(668, 5, 135, 0, 'yes', '2750', 104, 3),
(685, 5, 137, 0, 'yes', '5000', 105, 1),
(651, 5, 138, 0, 'yes', '4500', 98, 2),
(683, 5, 139, 0, 'yes', '4750', 104, 2),
(669, 5, 140, 0, 'yes', '5500', 103, 3);
...
(151, 0, 95, 0, 66, 668, NULL, '2025-08-05', '0'),
(152, 0, 3, 0, 66, 664, NULL, '2025-04-23', '0'),
(153, 0, 96, 1, 66, 651, NULL, '2025-08-05', '0'),
...
(159, 0, 81, 0, 65, 668, NULL, '2025-08-05', '0'),
(160, 0, 73, 0, 67, 668, NULL, '2025-08-05', '0'),
(161, 0, 39, 0, 5, 668, NULL, '2025-08-05', '0'),
(162, 0, 1, 0, 65, 663, NULL, '2025-04-25', '0'),
(163, 0, 96, 1, 65, 651, NULL, '2025-08-05', '0'),
(164, 0, 96, 1, 5, 651, NULL, '2025-08-05', '0'),
(165, 0, 94, 1, 67, 651, NULL, '2025-08-05', '0'),
(166, 0, 1, 0, 67, 652, NULL, '2025-05-03', '0'),
(167, 0, 1, 0, 65, 681, NULL, '2025-05-03', '0'),
(168, 3, 92, 1, 68, 651, '2025-08-05', '2025-08-05', 'Good Product'),
(169, 0, 3, 0, 68, 686, NULL, '2025-08-05', '0'),
(170, 0, 28, 0, 68, 668, NULL, '2025-08-05', '0'),
(171, 0, 2, 0, 68, 658, NULL, '2025-08-05', '0'),
(172, 0, 1, 0, 68, 647, NULL, '2025-08-07', '0');
...
INSERT INTO `wishlist` (`wishlist_id`, `list_name`, `share_link`, `customer_id`, `wishlist_description`, `privacy`, `date`, `time`) VALUES
(6, 'My Fav', '1_688d06288a467', 68, '', 'shared', '2025-08-01', '23:53:36'),
(7, 'My Fav', '7_688f734967f19', 68, '', 'shared', '2025-08-03', '20:03:45');
...
INSERT INTO `wishlist_items` (`wishlist_items_id`, `wishlist_id`, `quantity`, `total_amt`, `product_description_id`, `store_id`, `date`, `time`) VALUES
(6, 6, 1, 5990, 651, 5, '2025-08-03', '20:09:18');
...
--
-- Indexes for table `bmi_entries`
--
ALTER TABLE `bmi_entries`
...
--
-- AUTO_INCREMENT for table `bmi_entries`
--
ALTER TABLE `bmi_entries`
  MODIFY `bmi_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `customer_delivery_details`
  MODIFY `customer_delivery_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `new_ordered_products`
  MODIFY `new_ordered_products_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `new_orders`
--
ALTER TABLE `new_orders`
  MODIFY `new_orders_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;

--
-- AUTO_INCREMENT for table `order_delivery_details`
--
ALTER TABLE `order_delivery_details`
  MODIFY `order_delivery_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `product_details`
  MODIFY `product_details_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=141;

--
-- AUTO_INCREMENT for table `product_keys`
--
ALTER TABLE `product_keys`
  MODIFY `product_keys_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=173;
...
--
ALTER TABLE `wishlist_items`
  MODIFY `wishlist_items_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
