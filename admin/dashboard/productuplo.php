...
<body>
  <div class="wrapper">
    ...
    <script type="text/javascript">
      ...
      function upimg(cn, cat, it) {
        cn = cn + 1;
        for (var i = cn; i <= 10; i++) {
          $(".image-upload:has('#" + it + "file-input" + i + "')").remove();
        }
        var n = $('#nj' + it).val();
        for (var i = cn; i <= n; i++) {
      ...
      function numplusone(cn, cat, it) {
        var n = parseInt($('#nj' + it).val());
        console.log(n);
        if ($('#nj' + it).val() == '') {
          n = cn;
        }
                        ...
                        <tr>
                          <th class="ttd">
                            ...
                            <div class="prim col-sm-12">
                              <img src="../../images/<?= $row['category_id'] ?>/<?= $row['product_description_id'] ?>.jpg">
                            </div>
                          </th>
                          <?php
                          $itcn = $row['img_count'];
                          ...
                          <td rowspan=2 class="rwtd">
                            ...
                            <div class="col-sm-12">
                              <div id="imgdiv<?= $row['product_description_id'] ?>">
                                <?php
                                $ico = $itcn;
                                if ($itcn > 0) {
                                  for ($i = 1; $i <= $ico; $i++) {
                            ...
                            <div class="imdeta col-sm-12">
                              ...
                              <div style="display: flex;width:100%;margin-top: 20px;">
                                <button
                                  ...
                                  onclick="upimg(<?= $itcn ?>, <?= $row['category_id'] ?>, <?= $row['product_description_id'] ?>)">OK
                                </button>
                                <button
                                  class="addim"
                                  type="button"
                                  ...
                                  name="numi"
                                  onclick="numplusone(<?= $itcn ?>, <?= $row['category_id'] ?>, <?= $row['product_description_id'] ?>)">
                                ...
                                <button
                                  ...
                                  name="numk"
                                  onclick="numminone(<?= $itcn ?>, <?= $row['category_id'] ?>, <?= $row['product_description_id'] ?>)">
