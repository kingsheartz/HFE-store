...
try{
  ...
  $_SESSION['hfe_error']="Alert ! CONNECTION CAN'T BE ESTABLISHED";
}
*/
                      ...
                      <tbody>
                        <tr>
                          <td style="width:35%;text-align:left">
                            ...
                            <img border="0"  src="' . getImageUrl() . 'images/logo/logo.png" alt="HFE-Store.ml" style="border:none" class="CToWUd">
                            </a>
                          </td>
