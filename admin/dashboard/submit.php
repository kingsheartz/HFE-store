...
if (isset($_POST['setstorepass'])) {
  ...
  */
  ...
  $uniqid = uniqid();
  $activate_link = 'http://localhost:81/HFE/Healthcare-and-fitness/extras/OS/pages/FRL/register-v2.php?emailverified=1&email=' . $_POST['email'] . '&code=' . $uniqid;
  ...
  try {
    ...
    <table style="width:100%!important">
      <tbody>
        <tr style="" width="834px" height="60" background="http://localhost:81/HFE-store/images/logo/log2.jpg" align="center">
          <td>
                      ...
                      <tbody>
                        <tr>
                          <td style="width:35%;text-align:left">
                            <a style="color:#027cd8;text-decoration:none;outline:none;color:#ffffff;font-size:13px" href="http://localhost:81/HFE-store/" rel="noreferrer" target="_blank" data-saferedirecturl="">
                            <img border="0"  src="http://localhost:81/HFE-store/images/logo/logo.png" alt="HFE-Store.ml" style="border:none" class="CToWUd">
                            </a>
                          </td>
                          ...
                          <td align="left">
                              ...
                              <tbody>
                                <tr>
                                  <td valign="top"> <p style="font-family:Arial;color:#878787;font-size:12px;font-weight:normal;font-style:normal;font-stretch:normal;margin-top:7px;line-height:.85;padding-top:0px">Hi
                                    <span style="font-weight:bold;color:#191919"> ' . $name . ',</span> </p> <p style="font-family:Arial;font-size:12px;color:#878787;line-height:1.22;padding-top:0px;margin-top:0px">Your Email has been verified.</p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                            <table width="230" border="0" cellpadding="0" cellspacing="0" align="right">
                              <tbody>
                                <tr>
                                  <td valign="top">
                                    <p style="font-family:Arial;color:#747474;font-size:11px;font-weight:normal;text-align:right;font-style:normal;line-height:1.1;font-stretch:normal;margin-top:7px;padding-top:0px;color:#878787">Store ID : <span style="font-weight:bold;color:#000">OSSID' . sprintf('%06d', $id) . '</span> </p>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                        ...
                        <table style="background-color: ">
                          <tbody>
                            <tr>
                              ...
                              <td style="width:80%;text-align:center;font-family:Arial;color: #fff"> &#169; 2020 <a style="color:#027cd8;text-decoration:none;outline:none;font-weight:bold" href="http://localhost:81/HFE-store/">HFE-Store</a>. All rights reserved  </td>
    ...
    redirectWithError("An error occurred while trying to send your message: " . $mail->ErrorInfo . $e);
  }
}
