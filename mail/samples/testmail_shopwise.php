...
$placestmt_u->execute(array(':customer_id' => $customer_id));
...
while ($placerow_s = $placestmt_s->fetch(PDO::FETCH_ASSOC)) {
  ...
  $store_array[$i]['customername'] = $placerow_s['username'];
                                ...
                                <td valign="top">
                                  <p style="font-family:Arial;color:#878787;font-size:12px;font-weight:normal;font-style:normal;font-stretch:normal;margin-top:7px;line-height:.85;padding-top:0px">
                                    ...
                                    <span style="font-weight:bold;color:#191919">
                                      <?= $store_array[$l]['customername'] ?>,
                                    </span>
                                  </p>
                                  <p style="font-family:Arial;font-size:12px;color:#878787;line-height:1.22;padding-top:0px;margin-top:0px">
                              ...
                              <tr>
                                <td valign="top">
                                  <p
                                    ...
                                    Store ID <span style="font-weight:bold;color:#000">OSSID<?= $store_array[$l]['store_id'] ?></span>
                                  </p>
                                  <p
                                    style="font-family:Arial;font-size:11px;color:#878787;line-height:1.22;text-align:right;padding-top:0px">
                                    Order ID <span style="font-weight:bold;color:#000">OD<?= $order_id ?></span>
                                  </p>
                                </td>
                              </tr>
                            </tbody>
                              ...
                              <tr>
                                <td align="left">
                                  <p
                                    ...
                                    <b><?= $store_array[$l]['store_name'] ?></b>. Thanks for your cooperation with us and also wishing you best with your sales .
                                  </p>
                                </td>
                              </tr>
                            </tbody>
                              ...
                              <tr>
                                <td valign="top" align="left">
                                  <p style="padding-left:15px;margin-bottom:10px"> <a
                                      href="http://localhost:81/HFE-store/customer/Orders/yourorders.php?id=<?= $customer_id ?>"
                          ...
                          <td>
                            <h4 style="padding:5px;margin:0px;background-color: #02171e;color: white;padding-top: 0px;padding-bottom: 0px;font-family:Arial">
                              <table width="100%" cellspacing="10px">
                                ...
                                <tr>
                                  <td>
                                    <span style="color:#fff;">Customer id : OSUID' . $customer_id . '</span>
                                  </td>
                                  <td>
