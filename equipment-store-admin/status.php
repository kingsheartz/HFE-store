    ...
    <div class="wrapper">
        ...
        <style type="text/css">
            ...
            .form-control {
                ...
                background-color: #6a6a6ac7 !important;
                background-image: none;
        ...
        <div class="col-sm-12" style="background: #5d5d5d78;
    margin-top: 100px;">
            ...
            <form method="post" id="chfrm">
                ...
                <div class="form-group" class="store-opening-hours" id="store-opening-hours">
                    <div class="input-class store-opening-hours" style="">
