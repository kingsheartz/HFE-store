    ...
    1: [
      function (a, b, c) {
        ...
        function e(a, b) {
          ...
          return (
            "undefined" != typeof b && Object.defineProperties && Object.defineProperties(c, b), c
          );
        }
        function f(a) {
      ...
      function (a, b, c) {
        ...
        function i(a, b) {
          ...
          if (s(b)) {
            var c =
              "'" +
              JSON.stringify(b).replace(/^"|"$/g, "").replace(/'/g, "\\'").replace(/\\"/g, '"') +
              "'";
      ...
      function (a, b, c) {
        ...
        var p =
            ...
            for (var k = 1, l = !1, n = 0, o = a.length; o > n; ++n) {
              ...
              if (a.slice(n, e.length + n) == e) {
                ...
                var t = a.indexOf(g, n),
                  ...
                  x = 0;
                if (
                  ("-" == u[u.length - 1] && ((u = u.substring(0, u.length - 2)), (l = !0)),
          ...
          (c.compile = function (a, b) {
            ...
            (a = h
              ? [
                  "var __stack = { lineno: 1, input: " + f + ", filename: " + j + " };",
                  e.toString(),
                  "try {",
                  c.parse(a, b),
                  "} catch (err) {",
      ...
      function (a, b) {
        ...
        function c(a, b) {
          ...
          if (
            ...
            e.call(this),
            f.call(this, a, b),
            (c = this.load()) && ((d = c.items), (h = c.settings), h && (this._settings = h), d))
          )
        ...
        i(c.prototype, e.prototype),
          ...
          (c.prototype.add = function (a) {
            ...
            for (f = 0, e = i.length; e > f; f++)
              if (i[f].isEqual(a)) {
                (b = i[f]),
                  b.set("quantity", b.get("quantity") + (parseInt(a.quantity, 10) || 1)),
                  (j = f),
                  (k = !0);
                break;
              }
          ...
          (c.prototype.discount = function (a) {
            ...
            return (
              b ||
                (b =
                  ((parseFloat(this.settings("discount_rate_cart")) || 0) * this.subtotal()) / 100),
              (a = a || {}),
      ...
      function (a, b) {
        ...
        (i.render = function (a) {
          ...
          "undefined" == typeof window
            ? (b.exports = i)
            : (window.paypal || (window.paypal = {}), (window.paypal.minicart = i));
      },
              ...
              this._discount ||
                ...
                void 0 !== this.get("discount_amount")
                  ...
                  : void 0 !== this.get("discount_rate") &&
                    ...
                    (i = this.amount()),
                    (h += (c * i) / 100),
                    (h += (g.amount(this.get("discount_rate2") || c) * i * f) / 100)),
                (this._discount = h)),
              d(this._discount, a)
            );
          }),
              ...
              ? {
                  ...
                  remove: function (a, b, d) {
                    var e,
                      ...
                      h = c.length;
                    for (g = 0; h > g; g++)
                      if (((f = c[g]), f[0] === a && f[1] === b && f[2] === d && (e = f[3])))
                        return a.removeEventListener(b, e, !1), (c = c.slice(g)), !0;
                  },
                }
              : b.attachEvent
              ? {
          ...
          (c.prototype.fire = function (a) {
            ...
            if (f)
              for (b = 0, c = f.length; c > b; b++)
                (d = f[b][0]),
                  (e = f[b][1] || this),
                  "function" == typeof d && d.apply(e, Array.prototype.slice.call(arguments, 1));
          }),
          (b.exports = c);
      },
      {},
        ...
        (d.load = function () {
          if ("object" == typeof window && window.localStorage) {
            ...
            return (
              ...
              c && c.expires && ((a = new Date()), (b = new Date(c.expires)), a > b)
                ? void this.destroy()
                : c && c.value
            );
          }
