...
<style type="text/css">
    ...
    button.btn.btn-default.dropdown-toggle.mob-btn {
        background: black;
        border: 0px;
        color: white;
        height: 40px;
...
<div class="register"
    ...
    <div style="background-color: rgba(0,0,0,0.55);width: 100%;height: 100%;padding-top: 20px;padding-bottom: 20px;">
        <div class="container" style="padding: 0px;">
            <div class="lt_menu" style="color: white">
            ...
            <div style="margin:auto;width:100%;">
                <div class="register-main">
                    ...
                    <div class="login-form-grids" style="border-radius: 10px;width: 100%">
                        <div class="account-details pi account-details-active tab_reg">
                            ...
                            <form action="#" onsubmit="return err_display_fn();">
                                ...
                                <div class="input-group input-group_form bar-srch input-field"
                                    style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 15px;">
                                    <input type="text" id="last_name" oninput="$(this).removeClass('invalid');"
                                        required=" "
                                        style="margin: 0px;z-index: 0;border-top-right-radius: 0px;border-bottom-right-radius: 0px;'"
                                    ...
                                    <li style="list-style:none; ">
                                        <div id="pin" class="input-group input-group_form bar-srch input-field"
                                            ...
                                            <input type="tel" oninput="$(this).removeClass('invalid')"
                                                class="locmark validate" id="regpin" value="" name="pincode"
                                            ...
                                            <div class="input-group input-group_form bar-srch input-field"
                                                ...
                                                <span id="hide_locate" class="input-group-btn">
                                                    <button onclick="regsetlocation()"
                                                        ...
                                                        type="button"><span class="fa fa-check"></span></button>
                                                </span>
                                            </div>
                                        </div>
                                    </li><br>
                                ...
                                <div class="register-check-box">
                                    <div class="check">
                                        <label class="checkbox"><input type="checkbox" id="subscribe"
                                                name="checkbox"><i>
                        ...
                        <form action="#" onsubmit="return err_display_fn();">
                            <div class="li account-details tab_reg" style="">
                                ...
                                <h6 style="margin-top: 0px !important;"><i
                                        class="fa fa-info-circle fa-lg"></i>&nbsp;Login
                                    information</h6>
                                    ...
                                    <div class="input-group input-group_form bar-srch input-field"
                                        ...
                                        <span id="dis_pass1" class="input-group-btn">
                                            <button onclick="view()"
                                                ...
                                                style="color: #000;background-color:rgb(0 0 0);padding-top:10px;padding-bottom: 10px;outline: none;border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px"
                        ...
                        <form action="#" onsubmit="return err_display_fn();">
                            <div class="ada account-details tab_reg">
                                ...
                                <p style="color:#9f9f9f"><b>Note<b><span style="font-weight:normal"> : You can skip this
                                                step
                                ...
                                <div class="shipping_address" style="display: none;" id="stda_div">
                                    ...
                                    <p id="shipping_last_name_field" class="form-row form-row-last validate-required">
                                        ...
                                        <input type="text" oninput="$(this).removeClass('invalid')" value=""
                                            ...
                                            class="input-text validate" pattern="^[a-zA-Z ]{1,20}$"
                                            title="Use alphabets" required="">
                                    </p>
                            ...
                            <div id="update_user_details" style="display: none;">
                                <div class="register-check-box">
                                    <div class="check">
                                        <label class="checkbox"><input type="checkbox" id="accept" name="checkbox"><i>
                                            </i>I
                            ...
                            <div style="overflow:auto;">
                                <div style="float:right;">
                                    ...
                                    <button type="button" id="nextBtn" style="    background-color: rgb(12, 119, 204);
    ...
    cursor: pointer;
    display: inline;
    border-radius: 5px;" onclick="nextPrev(1)">Next</button>
                                </div>
                            </div>
