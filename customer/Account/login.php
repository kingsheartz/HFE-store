...
<div class="login" style="background: url(../../images/logo/log2.jpg) no-repeat;padding-top: 0px;padding-bottom: 0px;">
    <div style="background-color: rgba(0,0,0,0.55);width: 100%;height: 100%;padding-top: 30px;padding-bottom: 30px;">
        <div class="container">
            ...
            <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s" style="border-top: 0px;
    border-radius: 10px;">
                <form name="login_form">
                    ...
                    <div class="input-group bar-srch"
                        style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 30px;">
                        ...
                        <span id="dis_pass1" class="input-group-btn">
                            <button onclick="view()" onmouseover="$(this).css('background-color','#c0c0c0')"
                                onmouseleave="$(this).css('background-color','rgb(0 0 0')" style="    color: rgb(255 255 255);
    ...
    margin-left: -1px;" class="btn btn-default search_btn" type="button"><span class="fas fa-eye"></span></button>
                        </span>
