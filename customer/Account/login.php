    ...
    <div class="container">
      ...
      <div class="login-form-grids animated wow slideInUp" data-wow-delay=".5s" style="border-top: 0px; border-radius: 10px;">
        <form name="login_form">
          ...
          <div class="input-group bar-srch" style="padding: 0px;margin: 0px;left: 0px;right: 0px;margin-bottom: 15px;margin-top: 30px;">
      ...
      <p>
        <a href="../Account/registered.php">Register Here</a>
        (Or) go back to
        <a href="index.html">
          Home
