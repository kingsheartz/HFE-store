              ...
              <td>
                <div class="input-group bar-srch listgrp"
                  ...
                  <input type="text" placeholder="Wishlist name" id="wishlist_name_input" onkeyup="changed_details()"
                    ...
                    style="width: 100%;border-radius: 5px;outline-color: #e59700;border-top-right-radius: 0px;
                  ...
                  <span id="hide_fn" class="input-group-btn" style="display: none;">
                    <button onclick="reset_fn()" onmouseover="$(this).css('background-color','#bb0000')"
                      ...
                      style="color: white;background-color:red;padding-top:10px;padding-bottom: 10px;outline: none;
                        border-top-left-radius: 0px;border-bottom-left-radius: 0px;margin-left: -1px;padding-left: 28px;"
        ...
        <div class="col-md-12" style="margin:0px;padding: 0px;">
          <div class="product-content-right nopadding-margin"
            ...
            <h2 class="sidebar-title"
              style="border-left: 5px solid #c50505;border-top-left-radius: 10px;text-align: left;padding-bottom: 30px;
                padding-top: 20px;background-color: white;margin-top: 0px;font-weight:normal;border-bottom:#333;
                margin-bottom: 0px;border-radius: 10px;color: black;text-transform: capitalize;padding-left: 10px; ">
