                            ...
                            <table style="font-weight: bold;width: 100%;" class="tbl_s<?= $store_id . "i" . $product_description_id ?>">
                              <tr>
                                <table style="padding: 0px;width: 100%;" class="tbl_s<?= $store_id . "i" . $product_description_id ?>">
                                  ...
                                  <tr class="cart_item" style="width: 100%; background-color: #101010ff">
                                            ...
                                            <div class="row" style="margin-left: 5px;float: left;">
                                              <div class="col-md-6 full-size-cart-store-div" style="padding: 0px;margin-left: 20px;width: 200px;">
                                                ...
                                                <p style="margin-top:10px;">
                                                  <select
                                                    style="outline: none;border:cnone;background-color: #139b3b;color: white;padding: 5px;border-radius: 3px;padding-top: 1px;padding-bottom: 1px; "
                                              ...
                                              <div class="col-md-5 full-size-cart-price-div" style="padding-right: 0px;"></div>
                                            </div>
                                          </td>
                                          ...
                                          <div class="div-wrapper" style="text-align: left;padding: 0px;margin:0px;height: 40px;grid-gap: 0px;">
                                            ...
                                            <div style="padding: 0px;margin: 0px;">
                                              <button
                                                ...
                                                type="button"
                                                style="width: 100%;min-width: 50px;height: 40px;font-weight: bold;font-size: 14px;background-color: white;outline: none;border-color: #004123ff;padding: 0"
                                        ...
                                        <td style="padding: 0px;width: 45%">
                                          <button
                                            ...
                                            style="width: 100%;height: 40px;background-color: #f6f6f6;border: 0px solid #999;
                                                  ...
                                                  box-shadow: inset -1px 1px 15px 3px #ccc;">
