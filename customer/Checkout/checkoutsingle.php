...
<div style="background-color: #f8f8f8">
  ...
  <div class="checkout" style="padding-top: 0px;padding-bottom: 0px; background-color: rgba(255,255,255,0.05);">
    <div class="container" style="margin-left:0px;margin-right:6px;width: 100%;padding:0;"><br>
      <h2 style="padding:15px;">Your shopping cart contains: <span style="font-family: arial">1 Product(s)</span>
      </h2>
                  ...
                  <td class="invert-image"><a
                    ...
                    <div class="div-wrapper"
                      ...
                      <div style="padding: 0px;margin: 0px;">
                        ...
                        <select id="sel_s<?= $store_id . "i" . $idid ?>"
                          ...
                          <option value="2" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="2">2</option>
                          <option value="3" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="3">3</option>
                          <option value="4" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="4">4</option>
                          <option value="5" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="5">5</option>
                          <option value="6" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="6">6</option>
                          <option value="7" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="7">7</option>
                          <option value="8" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="8">8</option>
                          <option value="9" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option" data-a-html-content="9">9</option>
                          <option value="10" class="sc-update-quantity-option"
                            data-a-css-class="quantity-option quantity-option-10"
                            data-a-html-content="10+">10+</option>
                        </select>
                      ...
                      <div class="btn_add_q" style="padding: 0px;margin: 0px;width:25px"><button
                          ...
                          onclick="add_item_all('<?= $store_id ?>','<?= $idid ?>','<?= $t_mrp ?>')"
...
where st.store_id=:store_id AND id.item_description_id=:idid";
                  ...
                  ?>
                    <li style="color: #333">
                      <?= $row['item_name'] ?> <i>-</i> <span>&#8377; <span
                          id="mrp_s<?= $store_id . "i" . $idid ?>">
                          <?= $row['mrp'] ?>
                        </span></span>
                    </li>
                  <?php
                  ...
                  <li><i
                      ...
                      <i>-</i> </i><span
                      style="font-weight: bolder;font-family:sans-serif; ;color: black;">&#8377;<span
                        id="total_s<?= $store_id . "i" . $idid ?>">
                        <?= $total_amt ?>
                      </span></span></li>
                  <hr>
                </div><br>
