...
<div id="myModal-single" class="modal-single">
  ...
  <div class="modal-content-single">
    <div class="div-wrapper holder" style="margin-bottom: 30px">
      <div class="mySlides-single">
        <div class="numbertext-single">1 / <?= $img_cnt_row['img_count'] + 1 ?></div>
        <img src="../../images/<?= $row2['category_id'] ?>/<?= $row2['product_description_id'] ?>.jpg">
      </div>
      <?php
  ...
  <div class="modal-dialog modal-m" style="background-color: white;border-radius: 7px;">
    ...
    <div class="modal-content">
      <div
        ...
        <h4 class="modal-title">
          <span class="fa fa-info-circle fa-lg" style="color: #fff;"></span>
          <span style="color: #fff"> Share this item </span>
        </h4>
      </div>
      <div class="modal-body">
        <center>
...
<script>
  ...
  function sharelink(sm) {
    ...
    //whatsapp=1
    if (social_media == 1) {
      //window.open("whatsapp://send?text=See this product :- "+link+"");
      return;
    }
  }
