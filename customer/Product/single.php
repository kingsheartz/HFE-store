          ...
          ?>
            <div class="difhed">
              ...
              <button
                ...
                name="proceed"
                class="checkout-button button alt wc-forward">
                <a href="../Product/diff_views.php?recent=1" style="color:<?= $c2 ?>;">View all</a></button>
            </div>
            <div class="difcat " style="border-radius: 5px;">
              <div
                class="difrow hidescroll"
                id="difrow<?= json_decode(json_encode($row['product_description_id'] ?? null)) ?>"
                ...
                <button
                  ...
                  onclick="moveleft('difrow1<?= json_decode(json_encode($row['product_description_id'] ?? null)) ?>')"
                  style="display: none;">
                  <i class="fas fa-chevron-left"></i>
                </button>
                <button
                  class="right-arrow-btn-all shadow_all_none"
                  onclick="moveright('difrow1<?= json_decode(json_encode($row['product_description_id'] ?? null)) ?>')">
                  <i class="fas fa-chevron-right"></i>
                </button>
                <?php
