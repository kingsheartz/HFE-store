							...
							<td>
								<div class="input-group bar-srch"
									...
									<input readonly="true" type="text" class="" id="input_apk_link"
										...
										value="../../extras/APK/RELEASE/OneStore_version_high.apk" name="" required=" "
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<img src="../../images/logo/logost.svg" height="50px"><i
											style="font-size: 1.6em;font-weight: 800;font-family: 'Open Sans', sans-serif;font-style: normal;">
											Log in</i><br>
									...
									<p class="capson_warning" style="display: none;color: #d9534f"><i
...
if (isset($item_description_id)) {
	echo '<script>var item_description_id=' . $item_description_id . ';console.log("dghwgfey")</script>';
	...
	<div id="avail_stores" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal modal-xl hidescroll"
						...
						<table id="store" cellspacing="50px" cellpadding="20px" width="100%" class="single_product_info"
							...
							if (!is_null($rows) && $rows > 0) {
								...
								<tr style="background-color: #22374e;color: white">
									...
									<th style="border: none;" class="view_avail_stores">Store Name </th>
									<th style="border: none;" class="view_avail_stores">Price </th>
									<th style="border: none;" class="view_avail_stores">Distance(KM) </th>
									<th style="border: none;" class="view_avail_stores">Direction </th>
								</tr>
								<?php
									...
									<tr>
										<td style="padding: 0px;margin: 0px;">
											...
											<button id="btn<?= $row['store_id'] ?>"
												...
												class="element_cart"><i class="fa fa-check"></i> <i
										...
										<td>
											<form action="https://maps.google.com/maps" method="get" target="_blank">
												<input type="hidden" name="saddr" id="dadd1" value="" />
												<input type="hidden" name="daddr1"
        ...
        where product_description.product_description_id=:product_description_id";
								...
								<button
									style="height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none; "
									...
									<tr>
										<td style="padding: 0px;margin: 0px;">
											...
											<button class="load_btn"
												style="height: 45px;width:100%;border-color: white;background-color:#006904;color: white;border-radius:7px;outline: none;"><i
													class="fa fa-refresh fa-spin"></i> <i class="fa fa-heart"></i></button>
										</td>
	...
	<div id="avail_stores_buy" tabindex="-1" role="dialog" aria-labelledby="store_title" class="modal modal-xl hidescroll"
        ...
        where product_description.product_description_id=:product_description_id";
								...
								<button class="buynow_btn"
									...
									data-dismiss="modal" data-toggle="modal" data-target="#avail_buynow"> PLACE
									ORDER&nbsp;<i class="fa fa-shopping-bag"></i></i></button>
							</div>
						</div>
					</div>
					<div class="modal-footer" style="background-color: white">
