...
<body id="strt" class="scroll_handle_orange hidescroll" style="overflow-x:hidden; width: 100%;padding: 0px;">
			...
			<div style="height: 100% ;width: 100%;display: block;margin: 0px;left: 0px;right: 0px">
				<div style="display: flex;">
					<div class="col-lg-2 col-md-3 col-sm-3 topli " style="float: left;"
						...
						<div class="logo_img" style="padding: 0px;
	margin: 0px;
	width: 100px;
	height: auto;">
							...
							<a href="../Main/onestore.php"><img src="../../images/logo/logo-horizontal.png"
									height="50px" style="width: 200px;
	height: auto;
	position: absolute;
	left: -40px;
	top: -45px;
	...
	border: 0px;">
													<button type="button" id="search-panel"
														class="btn btn-default dropdown-toggle" onclick="catlistview()"
	...
	border: 0px;">
												...
												<input type="text" class="form-control" id="search"
													onkeyup="searchele()" name="Search" placeholder="Search" style="margin-top: 0px;
	z-index: 0;
	padding: 5px;
	height: 30px;
	...
	background: #76788473;">
												<span class="input-group-btn">
													<button onclick="check()"
														...
														onmouseleave="$(this).css('background-color','#fe9126')" style="    color: white;
	background-color: #5a88ca;
	border: 0px;
	height: 30px; " class="btn btn-default search_btn" type="button"><span class="fa fa-search"></span></button>
												</span>
											</div>
										</div>
									</div>
					...
					<div style="color: white;float: right;padding-left: 5px;padding: 0px;"
						class="col-lg-2 col-md-3 col-sm-3 topli" id="lg_top_ph_mail"><a href="tel:+918113990368"
							style="color:white;font-family:arial;padding: 0px;"><i class="fa fa-phone"
								aria-hidden="true"></i>Ph : <span><i>+91
									8113990368</i></span></a><br><i><span>Healthcare & Fitness Equipments</span></i>
					</div>
					<div style="color: white;float: right;" class="topli" id="sm_top_ph_mail"><i class="fa fa-phone"
								...
								<span style="font-size:30px;cursor:pointer" onclick="openNav()">&#9776;</span>
										...
										<li style="float: left;">
											<form action="#" method="post" class="last">
												<button class="location_marker popup2_open" type="submit" name="submit"
													value="">
												...
												<div id="cart" class="btn-group btn-shopping-cart">
													<a href="..\Cart\cart.php">
														<div class="shopcart">
															...
															<button class="carticon" onclick="cartview()" type="button"
																name="submit" value=""><i class="fa fa-cart-arrow-down"
																	aria-hidden="true"></i>
															</button>
															<span
																style="bottom: 0px;display: flex;justify-content:center;font-weight: normal;">Cart</span>
														</div>
													</a>
												</div>
											</form>
										...
										<li class="wishdiv">
											<form action="#" method="post" class="last">
												<button class="wishicon" type="button" name="submit" value=""
													onclick="location.href='../Wishlist/wishlist.php';">
													<i class="fa fa-heart" aria-hidden="true"></i>
												</button><span
													style="bottom: 0px;display: flex;justify-content:center;">Wishlist</span>
											</form>
										</li>
										<li style="float: left;" class="catdiv" id="sm_category">
											<form action="#" method="post" class="last">
												<button class="w3view-cart caticon popup1_open" type="button"
													...
													style="bottom: 0px;display: flex;justify-content:center;">Category</span>
											</form>
										</li>
										<?php
					...
					<div class="navbar-collapse collapse" id="mobile_menu" style="margin-top: 0px">
						<ul class="nav navbar-nav navbar-center">
							...
							if (isset($_SESSION['sid'])) {
								?>
								<li id="shopactive"><a
										href="../../equipment-store-admin/index.php?id=<?= $_SESSION['sid'] ?>"><i
									...
									<div id="cart" class="btn-group btn-shopping-cart">
										<a href="../Cart/cart.php">
											<div class="shopcart">
												...
												<input type="hidden" name="cmd" value="_cart">
												<input type="hidden" name="display" value="1">
												<button class="carticon" type="button" onclick="cartview()"
													name="submit" value=""><i class="fa fa-cart-arrow-down"
														aria-hidden="true"></i>
												</button>
											</div>
