...
<div class="container">
  <div class="row">
    <div class="col-md-12" style="background-color: #232323d9;color: aliceblue">
      <h2
        style="text-align: center;width:100%;padding-top: 5px;padding-bottom: 5px;background-color: #232323d9;margin-top:10px">
        <b>PRIVACY POLICY</b>
      </h2>
      <br>
      <p style="text-align: right;color:dimgray">Effective date: 2025-01-01</p>
      <h3><b>1.Introduction</b></h3>
      <p>Welcome to <b> <span style="color:rgba(54, 103, 207, 1)">HFE-Store</span></b>.</p>
      <p><b><span style="color:rgba(54, 103, 207, 1)">HFE-Store</span></b> (“us”, “we”, or “our”) operates
      ...
      <p><b>SERVICE</b> means the HFE-Store.ml website operated by <span style="color:rgba(54, 103, 207, 1)">HFE-Store</span>.</p>
      ...
      <p><span style="color:rgba(54, 103, 207, 1)">HFE-Store</span> uses the collected data for various purposes:</p>
      ...
      <p><span style="color:rgba(54, 103, 207, 1)">HFE-Store</span> will take all the steps reasonably necessary to ensure
