    ...
    <ol class="faq">
      <li class="item1"><a href="#" title="click here" class="que">What makes you different from your competitors
        ...
        <ol>
          <li class="subitem1">
            <p>
              We provide location of stores to the customers,it helped our customers not to roam in search of products and wait till it arrives.
            </p>
          </li>
        </ol>
      </li>
      <li class="item2">
        <a href="#" title="click here" class="que">
        ...
        <ol>
          <li class="subitem1">
            <p>Yes, we laid a way for both in case of damaged products and the customer must report with in 48 hours from the time of delivery.</p>
          </li>
        </ol>
      </li>
      <li class="item3"><a href="#" title="click here" class="que">What payment methods do you accept?</a>
        <ol>
          <li class="subitem1">
            <p>Currently we provide to our customers 2 choice 1) booking and 2) cash on delivery. Later we try to include card methods in it.</p>
          </li>
        </ol>
      </li>
      ...
      <li class="item5">
        <a href="#" title="click here" class="que">Can i make changes to an order i already placed ?</a>
        <ol>
          <li class="subitem1">
      ...
      <li class="item6">
        <a href="#" title="click here" class="que">How do i get a new password?</a>
        <ol>
          <li class="subitem1">
            <p>
            <ol>
      ...
      <li class="item8"><a href="#" title="click here" class="que">What does 'Out of Stock' mean ?</a>
        <ol>
          <li class="subitem1">
            <p> An item is marked as 'Out of stock' when it is not available with any Shoppers at the moment; you won't be able to buy it now.</p>
          </li>
        </ol>
      </li>
      ...
      <li class="item10"><a href="#" title="click here" class="que">How can I connect with you ?</a>
        <ol>
          <li class="subitem1">
            <p>
              It's very simple just click <a href="../Main/contact.php">"Contact us"</a>
              option and there would be 3 ways<br><br>
              1.What's app<br>
              2.Facebook<br>
              3.Mail<br><br>
              you can choose as to your choice.
            </p>
          </li>
        </ol>
      </li>
      ...
      $(function() {
        ...
        menu_a.click(function(e) {
          ...
          if (!$(this).hasClass('active')) {
            ...
            menu_ol.filter(':visible').slideUp('normal');
